...
var Trackr__default = /*#__PURE__*/_interopDefaultLegacy(Trackr);
var EJSON__default = /*#__PURE__*/_interopDefaultLegacy(EJSON);
var EventEmitter__default = /*#__PURE__*/_interopDefaultLegacy(EventEmitter);
var SHA256__default = /*#__PURE__*/_interopDefaultLegacy(SHA256);
var Minimongo__default = /*#__PURE__*/_interopDefaultLegacy(Minimongo);
...
EJSON__default['default'].addType('oid', function (str) {
...
var Socket = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Socket, [{
    ...
    value: function send(object) {
      if (!this.closing) {
        var message = EJSON__default['default'].stringify(object);
        this.rawSocket.send(message); // Emit a copy of the object, as the listener might mutate it.

        this.emit('message:out', EJSON__default['default'].parse(message));
      }
    }
  }, {
    key: "open",
    value: function open() {
      ...
      */
      ...
      this.rawSocket.onmessage = function (message) {
        ...
        try {
          object = EJSON__default['default'].parse(message.data);
        } catch (ignore) {
...
function hashPassword(password) {
  return {
    digest: SHA256__default['default'](password).toString(),
    algorithm: 'sha-256'
  };
}
function isPlainObject(obj) {
  return !!obj && !(typeof obj === 'number') && !(typeof obj === 'string') && !(typeof obj === 'boolean') && !Array.isArray(obj) && !(obj === null) && !(obj instanceof RegExp) && !(typeof obj === 'function') && !(obj instanceof Date) && !EJSON__default['default'].isBinary(obj) && !(obj instanceof MongoID.ObjectID);
}
...
var db = new Minimongo__default['default']();
var NetInfo = null;
var isReactNative = false;
var Storage = null;
var InteractionManager = null;

var configureOptionalDeps = function configureOptionalDeps() {
  ...
  isReactNative = options.isReactNative;
...
function runAfterOtherComputations(fn) {
  config.InteractionManager ? config.InteractionManager.runAfterInteractions(function () {
    Trackr__default['default'].afterFlush(function () {
      fn();
    });
  }) : Trackr__default['default'].afterFlush(function () {
    fn();
...
function wrapTransform(transform) {
  ...
  var wrapped = function wrapped(doc) {
    ...
    var transformed = Trackr__default['default'].nonreactive(function () {
    ...
    if (transformed._id) {
      if (!EJSON__default['default'].equals(transformed._id, id)) {
...
var useTracker = (function (trackerFn) {
  ...
  var meteorDataDep = new Trackr__default['default'].Dependency();
  ...
  React.useEffect(function () {
    stopComputation();
    Trackr__default['default'].autorun(function (currentComputation) {
...
var stringify = function stringify(value) {
  ...
  return EJSON__default['default'].stringify(value);
};
...
var parse = function parse(serialized) {
  ...
  return EJSON__default['default'].parse(serialized);
};
...
var ReactiveDict = /*#__PURE__*/function () {
  ...
  _createClass(ReactiveDict, [{
    ...
    value: function equals(key, value) {
      ...
      return EJSON__default['default'].equals(oldValue, value);
    }
  }, {
    key: "_setObject",
...
var User = {
  ...
  handleLogout: function handleLogout() {
    var Storage = config.AsyncStorage;
...
module.exports = _objectSpread2(_objectSpread2({
  configureOptionalDeps: configureOptionalDeps,
  Accounts: Accounts,
  Random: Random,
  Tracker: Trackr__default['default'],
  EJSON: EJSON__default['default'],
  Error: MeteorError,
  ...
  connect: function connect(endpoint, options) {
    ...
    if (!Data.ddp) {
      ...
      if (config.NetInfo) {
        unsubscribe = config.NetInfo.addEventListener(function (_ref) {
  ...
  subscribe: function subscribe(name) {
    ...
    for (var i in Data.subscriptions) {
      ...
      if (sub.name === name && EJSON__default['default'].equals(sub.params, params)) {
        existing = sub;
      }
    }
    ...
    if (existing) {
      ...
      Data.subscriptions[id] = {
        ...
        name: name,
        params: EJSON__default['default'].clone(params),
        inactive: false,
        ready: false,
        readyDeps: new Trackr__default['default'].Dependency(),
    ...
    if (Trackr__default['default'].active) {
      ...
      // an afterFlush.
      Trackr__default['default'].onInvalidate(function () {
        if (Data.subscriptions[id]) {
